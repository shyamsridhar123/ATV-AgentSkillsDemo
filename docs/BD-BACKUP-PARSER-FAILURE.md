...
That means a failure seen from a worktree such as `/tmp/beth-pr46` can still be
caused by the main repository file at:

```text
/home/sschofield/repos/beth/.beads/backup/backup_state.json
```
